...
final actor TransactionsFileCache {
    ...
    private(set) var transactions: [Transaction] = [
        Transaction(id: 0, accountId: 0, categoryId: 1, amount: 1500, transactionDate: Date(), createdAt: Date(), updatedAt: Date()),
        Transaction(id: 1, accountId: 0, categoryId: 2, amount: 15040, transactionDate: Date(), createdAt: Date(), updatedAt: Date()),
        Transaction(id: 2, accountId: 0, categoryId: 3, amount: 100, transactionDate: Date(), createdAt: Date(), updatedAt: Date()),
        Transaction(id: 3, accountId: 0, categoryId: 9, amount: 1000, transactionDate: Date(), createdAt: Date(), updatedAt: Date())
    ]
